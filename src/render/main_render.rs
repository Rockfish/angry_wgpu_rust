...
use crate::render::textures::{create_depth_texture_view, create_shadow_map_material};
...
impl WorldRender {
    ...
    pub fn render(&mut self, context: &GpuContext, world: &World) {
...

        {
            ...
            render_pass = render_player(context, world, render_pass, player, &self.shadow_map_material);
            ...
            render_pass = render_enemy_model(context, world, render_pass, enemy_system, &self.shadow_map_material);
        }
